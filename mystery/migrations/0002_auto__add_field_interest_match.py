...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interest.match'
        db.add_column(u'mystery_interest', 'match',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mystery.Interest'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interest.match'
        db.delete_column(u'mystery_interest', 'match_id')
